...
static const char *fonts[]          = { "Hack:pixelsize=16:antialias=true:autohint=true" , "FontAwesome:size=16" };
...
//	{ MODKEY|ShiftMask,             XK_Left,   movestack,      {.i = -1 } },
	...
	{  MODKEY,	               XK_a,        spawn,         SHCMD("bash $HOME/.qolscripts/lsqol.sh") },
	
	// for searching 
	
	{ MODKEY|ShiftMask,            XK_s,        spawn,         SHCMD("bash $HOME/.qolscripts/locater.sh") },

	// Screenshot

	{ MODKEY,                      XK_w,      spawn,          SHCMD("import $HOME/Desktop/screenshots/$(date | awk '{print $1$4$7$2$3 }').png") },
